...
<link href="/wkapi/Public/admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="index.php?m=admin&c=index&a=dologin" method="post">
      <div class="row cl">
...
<div class="footer">Copyright wanke by 2016 hedong</div>
