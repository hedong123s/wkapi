...
<nav class="breadcrumb"><i class="iconfont">&#xf012b;</i> 首页 <span class="c-gray en">&gt;</span> 用户管理 <span class="c-gray en">&gt;</span> 用户留言日志 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="icon-refresh"></i></a></nav>
<div class="pd-20">
<!--
...
-->
  ...
  <!--<a href="javascript:;" onclick="user_add('550','','添加用户','<?php echo U('house/add');?>')" class="btn btn-primary radius"><i class="icon-plus"></i> 添加房源</a></span> --><span class="r">共有数据：<strong><?php echo count($res); ?></strong> 条</span> </div>
  <table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <tbody>
      ...
      <td><?php echo ($r["remark"]); ?></td>
			...
			<a title="编辑" href="javascript:;" onclick="user_edit('4','600','','编辑','<?php echo U('house/edit',array('id'=>$r['id']));?>')" class="ml-5" style="text-decoration:none"><i class="icon-edit"></i></a>
