 ...
 $rs = M('wkdetail')->where(array('rid'=>$r['id']))->find(); ?>
      ...
      <td>
          ...
          <a href="/wkapi/Public/../uploads/<?php echo ($rs["img4"]); ?>" target="_blank"><img src = '/wkapi/Public/../uploads/<?php echo ($rs["img4"]); ?>' style="width=50px;height:50px;"/></a>
			...
			<a title="编辑" href="index.php?m=admin&c=house&a=edit&id=<?php echo ($r["id"]); ?>" onclick="user_edit('4','600','','编辑','index.php?m=admin&c=house&a=edit&id=<?php echo ($r["id"]); ?>')" class="ml-5" style="text-decoration:none" target="_blank"><i class="icon-edit"></i></a>
